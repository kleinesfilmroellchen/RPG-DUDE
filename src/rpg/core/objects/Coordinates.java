...
public class Coordinates {
	...
	public void setCoords(int[] arr) {
		this.setCoords(arr[0], arr[1], arr[2]);
	}
	 ...
	 * @return The coordinates of this object with
	 * {@code [0] = x, [1] = y, [2] = z}.
	 */
	 ...
	 * @param l The "name" of the coordinate to get. Can be "x", "y" or "z".
	 * Case-insensitive.
	 * @return The specified coordinate's value.
	 * @throws IllegalArgumentException If the argument character was non of the
	 * above specified.
	 */
	...
	/**
	 * Checks whether two coordinate objects contain the same location in all
	 * dimensions.
	...
	public boolean neighboring(Coordinates other) {
		...
		int differenceX = Math.abs(this.x - other.x), differenceY = Math.abs(this.y - other.y),
				differenceZ = Math.abs(this.z - other.z);
	 ...
	 * @return -1 if neighbor further east, 1 if neighbor further west and 0 if
	 * neighbor is equal or no neighbor at all.
	 */
	 ...
	 * @param other The other Coordinates to check.
	 * @return -1 if neighbor is further south, 1 if neighbor further north and 0 if
	 * neighbor is equal or no neighbor at all.
	 */
	 ...
	 * @param other The other Coordinates to check.
	 * @return -1 if neighbor is lower, 1 if neighbor is higher and 0 if neighbor is
	 * equal or no neighbor at all.
	 */
